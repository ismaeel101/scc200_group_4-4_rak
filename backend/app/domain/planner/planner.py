                                ...
                                for dr in dest_rows:
                                    ...
                                    if walk1_m > 50:
                                        ...
                                        if not (origin_exact_usable and origin_id == o_stop):
                                            legs.append(self._walk_leg_dict(origin_name, orig_stop_row["name"] if orig_stop_row else o_stop, walk_depart, walk_arrive, from_lat=origin_lat, from_lon=origin_lon, to_lat=o_lat, to_lon=o_lon))
